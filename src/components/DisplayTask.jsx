    ...
    return (
        <>
           <div id="incomplete-tasks" className="mb-6 bg-white p-6 rounded-lg shadow-lg">
                <h2 className="text-xl font-semibold text-gray-800 mb-4 border-b pb-2">À Faire</h2>
                <div id="incomplete-tasks-block" >
                    {todos.map((task) => {
                        if (!task.completed) 
                            return (
                                <div className="mb-2 task-card relative divContentTask bg-gray-100 rounded-lg shadow-sm  group cursor-pointer hover:bg-gray-50 transition duration-150" key={task.id}>
                                    ...
                                    <div className="task-content w-8/12 flex flex-col justify-center cursor-pointer">
            ...
            <div id="complete-tasks" className="bg-white p-6 rounded-lg shadow-lg">
                <h2 className="text-xl font-semibold text-gray-800 mb-4 border-b pb-2">Complétées</h2>
